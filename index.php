...
$sql = "Select * from Wizard_data"; 
$first = "Select first_name from Wizard_data where first_name like 'A%'"
...
{show results
    ...
    {
	  echo "<p>";
	   echo "ProduceID: <b>" . $row['NameID'] . "</b><br />";
	   echo "Produce Name: <b>" . $row['first _name'] . "</b><br />";
	   echo "Description: <b>" . $row['middle_name'] . "</b><br />";
	   echo "Description: <b>" . $row['last_name'] . "</b><br />";
	   echo "Description: <b>" . $row['superpower'] . "</b><br />";
	  // echo '<a href ="produce_view.php?id=' . $row['NameID'] . '">' . $row['ProduceName'] . '</a><br />';
	   echo "</p>";
   }
}else{//no records
